...
const Header = () => {
    ...
    const [ dataSource, setDataSouce] = useState(dummyData)
  ...
  return (
    ...
    <div>
       ...
       <h3 className='adminpage'>Admin UI Page</h3>
       </div>
...
<div class="input-group mb-3">
  ...
  <input type="text" className="form-control" placeholder="Search" aria-label="Username" aria-describedby="basic-addon1" value={value}
  onChange ={filterData}
  />
</div>
